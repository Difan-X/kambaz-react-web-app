    ...
    return (
        <div id="wd-css-position-relative">
            ...
            <div className="wd-bg-color-gray">
                <div className="wd-bg-color-yellow wd-dimension-portrait wd-pos-relative">
            ...
            <div id="wd-css-position-absolute" style={{ position: "relative", marginTop: "3rem" }}>
                ...
                {/* Make room below for next exercises */}
                <br /><br /><br /><br /><br /><br /><br />
            </div>

            <div id="wd-css-position-fixed" style={{ marginTop: "3rem" }}>
                ...
                {/* Add some extra height so you can scroll */}
